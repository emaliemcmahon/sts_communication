...
class VoxelOverlapCommunicatePointlight:
    """
    ...
    (see batch_voxel_overlap_communicate_pointlight.sh / `make voxel_overlap_communicate_pointlight`)
    and then run voxel_overlap_communicate_pointlight_group.py to aggregate
    results across subjects.
    """

    def __init__(self, args):
        self.process = 'VoxelOverlapCommunicatePointlight'
...
def main():
    ...
    VoxelOverlapCommunicatePointlight(args).run()
